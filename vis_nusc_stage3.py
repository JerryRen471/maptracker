"""BEV visualization for nuScenes stage3 iter_10440 checkpoint.

Reads the submission_vector.json produced by inline eval and plots
GT vs prediction vectors in BEV for a few scenes.
"""
...
work_dir = Path("/root/maptracker/work_dirs/maptracker_nusc_newsplit_5frame_span10_stage3_joint_finetune")
cfg_path = Path("/root/maptracker/plugin/configs/maptracker/nuscenes_newsplit/maptracker_nusc_newsplit_5frame_span10_stage3_joint_finetune.py")
sub_path = work_dir / "submission_vector.json"
out_root = work_dir / "bev_vis_iter10440"
...
sorted_scenes = sorted(scene_indices.keys())
print(f"total scenes: {len(sorted_scenes)}, visualizing first {MAX_SCENES}")
sorted_scenes = sorted_scenes[:MAX_SCENES]
